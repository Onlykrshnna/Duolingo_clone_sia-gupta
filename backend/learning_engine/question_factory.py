    ...
    def build_word_bank_sentence(self, drill: dict) -> dict:
        ...
        return {
            ...
            "metadata": {
                ...
                "source_text": drill.get("english") or drill.get("englishMeaning") or "",
                "target_text": drill.get("target") or drill.get("targetWord") or "",
                "englishMeaning": drill.get("english") or drill.get("englishMeaning") or "",
                "targetWord": drill.get("target") or drill.get("targetWord") or "",
